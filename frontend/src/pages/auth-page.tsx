...
export default function AuthPage() {
  ...
  const loginMutation = useMutation({
    ...
    onError: (error: any) => {
      ...
      // Handle single-session error with special styling
      if (error.status === 403 && error.message.includes("already logged in")) {
        title = "Account Already Active";
        description = "This account is currently logged in on another device or browser. Please log out from the other session first, or close that browser completely to continue.";
      }
      ...
      toast({
        ...
        description,
        variant: "destructive",
        duration: 8000, // Longer duration for single-session errors
      });
    },
  });
      ...
      <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        ...
        <div className="space-y-6 text-center lg:text-left">
          <div className="space-y-4">
            ...
            <p className="text-xl lg:text-2xl text-gray-600 font-medium">
              Aviation Maintenance Technician Study Platform
            </p>
          </div>
          ...
          <div className="space-y-4 text-gray-600">
            <div className="flex items-center gap-3 justify-center lg:justify-start">
              ...
              <span>8 AMT Certification Categories</span>
            </div>
            <div className="flex items-center gap-3 justify-center lg:justify-start">
            ...
            <div className="flex items-center gap-3 justify-center lg:justify-start">
              ...
              <span>Mock Exams & Battle Mode</span>
            </div>
            <div className="flex items-center gap-3 justify-center lg:justify-start">
        ...
        <Card className="w-full max-w-md mx-auto bg-white/90 backdrop-blur-sm shadow-xl border-0">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl">Welcome to AVEX</CardTitle>
            <CardDescription>
              ...
              <TabsContent value="register" className="space-y-4">
                <form onSubmit={registerForm.handleSubmit(onRegister)} className="space-y-4">
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 text-sm text-blue-800">
                    ...
                    <p>New accounts require admin approval before access is granted. You'll be notified once your account is reviewed.</p>
                  </div>
