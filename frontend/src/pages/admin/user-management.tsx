...
export default function UserManagement() {
  ...
  const filteredUsers = allUsers?.filter((userData: any) => {
    const matchesSearch = 
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-avex-blue">{allUsers?.length || 0}</p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-blue-500">
                    {allUsers?.filter((u: any) => u.role === 'basic').length || 0}
                  </p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-yellow-500">
                    {allUsers?.filter((u: any) => u.role === 'premium').length || 0}
                  </p>
                </div>
                              ...
                              <AlertDialogContent>
                                <AlertDialogHeader>
                                  ...
                                  <AlertDialogDescription>
                                    ...
                                    for {userData.firstName} {userData.lastName} and remove all their data from our servers.
                                  </AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter>
