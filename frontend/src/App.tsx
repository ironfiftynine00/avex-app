...
import PracticalStationPage from "@/pages/practical-station";
  ...
  return (
    <div className="min-h-screen bg-background pb-16">
      <Switch>
        ...
        {/* Dynamic Practical Station route */}
        <Route path="/practical/:slug">
          {(params) => <PracticalStationPage slug={params.slug} />}
        </Route>
